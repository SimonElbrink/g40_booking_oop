...
public class Address {
  ...
  public void setStreetAddress(String streetAddress) {
    if (streetAddress == null) {
      throw new IllegalArgumentException("Parameter: String streetAddress was null");
    }
  ...
  public void setZipCode(String zipCode) {
    if (zipCode == null) {
      throw new IllegalArgumentException("Parameter: String zipCode was null");
    }
  ...
  public void setCity(String city) {
    if (city == null) {
      throw new IllegalArgumentException("Parameter: String city was null");
    }
    this.city = city;
  }
}
